...
<div class="social">
	...
	echo '<a href="https://www.linkedin.com/company/newaccesscompta" target="_blank"><img class="social-icon" src="' . get_template_directory_uri() . '/img/linkedin2.svg" alt="Linkedin" title="Linkedin"></a>';
